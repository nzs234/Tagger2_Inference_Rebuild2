...
The source compatibility baseline introduced in V1.03 and retained by V1.04.1 is pinned to
...
seeded. This deterministic orchestration contract was introduced in V1.03 and remains in V1.04.1.
...
V1.04.1 verification is emitted by the release gate rather than copied into this
